...
import com.ua.config.security.jwt.AuthEntryPointJwt;
import com.ua.config.security.jwt.AuthTokenFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers(HttpMethod.DELETE, "/api/departments/**",
                        "/api/dealers/**",
                        "/api/contracts/**",
                        "/api/nomenclatures/**",
                        "/api/price_types/**",
                        "/api/prices/**").access("hasRole('ROLE_ADMIN')")
                .antMatchers(HttpMethod.PUT, "/api/departments/**",
                        "/api/price_types/**",
                        "/api/nomenclatures/**",
                        "/api/prices/**").access("hasRole('ROLE_ADMIN')")
                .antMatchers(HttpMethod.POST, "/api/departments/**",
                        "/api/nomenclatures/**",
                        "/api/price_types/**",
                        "/api/prices/**").access("hasRole('ROLE_ADMIN')")
